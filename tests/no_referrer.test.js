...
test('测试no-referrer策略下载', async ({ page }) => {
  // 创建下载目录
  const downloadPath = path.join(__dirname, '../test_downloads_referrer');
